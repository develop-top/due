...
// HasGate 检测是否存在某个网关
func (p *Proxy) HasGate(ctx context.Context, gid string) bool {
	return p.gateLinker.Has(ctx, gid)
}
...
// HasNode 检测是否存在某个节点
func (p *Proxy) HasNode(ctx context.Context, nid string) bool {
	return p.nodeLinker.Has(ctx, nid)
}
