...
const (
	...
	// RPCMessageContentKey is the content of message transmitted or received.
	RPCMessageContentKey = attribute.Key("message.content")
	...
	// HttpRequestHeaderKey is the header of http request.
...
var (
	...
	// RPCSystemTCP is the semantic convention for tpc as the remoting system.
	RPCSystemTCP = semconv.RPCSystemKey.String("tcp")
